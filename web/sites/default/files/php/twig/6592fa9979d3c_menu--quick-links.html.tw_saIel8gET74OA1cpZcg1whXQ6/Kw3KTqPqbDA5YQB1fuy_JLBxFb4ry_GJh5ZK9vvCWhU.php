...
/* themes/custom/silver/templates/menu/menu--quick-links.html.twig */
class __TwigTemplate_9b6f1bc54df67c3fea1fa485d60e4ef0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
  ...
  ";
    ...
    {
        return "themes/custom/silver/templates/menu/menu--quick-links.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <div class=\"d-flex flex-column justify-content-start\"{{ attributes }}>
    {% else %}
      <ul>
    {% endif %}
    {% for item in items %}
  ...
  {% endif %}
{% endmacro %}
", "themes/custom/silver/templates/menu/menu--quick-links.html.twig", "C:\\laragon\\www\\drupaltheme\\web\\themes\\custom\\silver\\templates\\menu\\menu--quick-links.html.twig");
    }
